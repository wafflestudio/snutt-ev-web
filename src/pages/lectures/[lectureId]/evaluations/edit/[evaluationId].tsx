import { fetchEvaluation, fetchSemesterLectures } from '@/apis/ev';
...
export const getServerSideProps = withGetServerSideProps(
  async (context, { queryClient }) => {
    ...
    const lectureId = Number(context.query.lectureId);
    const evaluationId = Number(context.query.evaluationId);

    await Promise.all([
      queryClient.prefetchQuery(['lectureSemester', lectureId] as const, ({ queryKey: [, id] }) =>
        fetchSemesterLectures({ params: { id }, context }),
      ),

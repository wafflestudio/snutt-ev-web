  ...
  return (
    <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path
        ...
        fill={stroke}
      />
      <rect x="6.75" y="7.75" width="16.5" height="0.5" rx="0.25" stroke={stroke} strokeWidth="0.5" />
      <rect x="12.75" y="12.25" width="0.5" height="7.5" rx="0.25" stroke={stroke} strokeWidth="0.5" />
      <path
        d="M14 6.25H16C16.6904 6.25 17.25 6.80964 17.25 7.5V7.75H12.75V7.5C12.75 6.80964 13.3096 6.25 14 6.25Z"
        stroke={stroke}
        strokeWidth="1.5"
      />
      <rect x="16.75" y="12.25" width="0.5" height="7.5" rx="0.25" stroke={stroke} strokeWidth="0.5" />
    </svg>
  );
};
